	...
	public void lireClient(String nom, String prenom) {
		...
		for (Client client : this.clients) {
			if (nom == client.getNom() && prenom == client.getPrenom()) {
				System.out.println("Donn�es du client " + nom + " " + prenom + " : Adresse = " + client.getAdresse() + ", code postal = " + client.getCodepostal() + ", ville = " + client.getVille()
						+ ", numero de t�l�phone = " + client.getNumerotelephone());
				dejaaffiche = true;
			}
